...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget_3.setHorizontalHeaderLabels(['Дата', 'От кого', 'Название документа', 'Система координат', 'Актуальность', 'id'])
        ...
        self.tableWidget_4.setHorizontalHeaderLabels(['Номер', 'Наименование', 'Последовательность', 'X', 'Y', 'Z', 'Пласт', 'Актуальность', 'id'])
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("MainWindow", "Расчет_бурения"))
